...
{
	LOG_INF("DMA IRQ ch=%u st=%d", channel, status);
...
DEVICE_DT_INST_DEFINE(0, disk_stm32_sdmmc_init, NULL, &stm32_sdmmc_priv_1, PM_DEVICE_DT_INST_GET(0),
